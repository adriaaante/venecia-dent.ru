...
DOCTORS = [
    ...
    {'slug': 'tatarov', 'name': 'Татаров Альберт Олегович',
     'speciality': 'стоматолог-ортопед',
     'description': 'Стоматолог-ортопед, хирург. Коронки, виниры и вкладки, съёмные и несъёмные протезы, удаление зубов.',
     'service': ('konsultaciya', 'Консультация стоматолога с планом лечения'),
     'price': 1000,
     'photo': False,   # фото врача ещё не прислали — в карточке стоит заглушка
     'check_price': ('ceny.html', 'Консультация стоматолога с планом лечения')},
    {'slug': 'kenzhabaeva', 'name': 'Кенжабаева Зухро Бурхоновна',
     'speciality': 'стоматолог-гигиенист',
     'description': 'Гигиенист стоматологический. Профессиональная гигиена полости рта, чистка Air Flow, фторирование.',
     'service': ('gigiena', 'Комплексная гигиена (ультразвук + Air Flow + полировка)'),
     'price': 5000,
     'check_price': ('ceny.html', 'Комплексная гигиена \(ультразвук \+ Air Flow \+ полировка\)')},
]

# Гигиенист в фиде — это нормально (уточнено с владельцем 06.09.2026).
# «Стоматолог-гигиенист» есть в перечне специальностей Яндекса, а сама
# профессия по закону требует среднего профессионального образования —
# требовать для неё высшее было бы противоречием. У Кенжабаевой диплом
# гигиениста (колледж «Галактика», 2020), профпереподготовка по той же
# специальности и действующая аккредитация 2025 года — этого достаточно.
EXCLUDE = {}
