...
# ⚠️ Кенжабаева в фид НЕ идёт (06.09.2026). Владелец 31.08.2026 сказал, что
# у неё высшее медицинское образование, и она была добавлена в фид. Но
# присланные им же документы говорят обратное: выписка из ФРМР об
# аккредитации 2025 года прямо указывает уровень образования «Среднее —
# профессиональное», дипломы — колледжа. Тематика DOCTORS принимает только
# специалистов с высшим медицинским образованием, поэтому оффер снят:
# нарушение = Яндекс блокирует предложения по всему фиду.
EXCLUDE = {
    'kendabaeva': 'гигиенист со средним профессиональным образованием '
                  '(по выписке ФРМР 2025) — тематика DOCTORS требует высшего',
}
