...
DOCTORS = [
    ...
    {'slug': 'kendabaeva', 'name': 'Кендабаева Зухро Бурхоновна',
...
# У Кендабаевой высшее медицинское образование (подтверждено владельцем
# 31.08.2026) — она в фиде со специальностью «стоматолог-гигиенист».
EXCLUDE = {}
